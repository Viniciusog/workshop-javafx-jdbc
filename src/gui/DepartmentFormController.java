...
public class DepartmentFormController implements Initializable {
	...
	// Classe DepartmentformController é a classe que emite o evento.
	// Já a classe DepartmentListController é a observadora
	...
	private void setErrorMessage(Map<String, String> errors) {
		Set<String> fields = errors.keySet(); // O nome do campo é a chave do map

		if (fields.contains("name")) {
			labelErrorName.setText(errors.get("name")); // Pegando a mensagem correspondente a chave name
			// Em seguida setando esta mensagem no labelError
		}
	}
}